...
| ModuleStatus               |                     | Both              | ModuleName*, Verbose (true/false)*                                       | Admin           | Yes      | Displays the status of the given module or all modules if no module name is supplied.                                |
| UpdateModule               |                     | Both              | ModuleName*                                                              | Admin           | Yes      | Forces an update of the given module or all modules if no module name is supplied.                                   |
...
| **Name**                   | **Alias**           | **Discord/Eco**   | **Parameters** (* = Optional)                                            | **Permissions** | **RCON** | **Description**                                                                                                      |
|----------------------------|---------------------|-------------------|--------------------------------------------------------------------------|-----------------|----------|----------------------------------------------------------------------------------------------------------------------|
| Trades                     | DLT                 | Discord / Moose   | SearchName                                                               | User            | No       | Displays available trades by player, tag, item or store. The search name is case insensitive and will auto complete. |
...
| **Name**                   | **Alias**           | **Discord/Eco**   | **Parameters** (* = Optional)                                            | **Permissions** | **RCON** | **Description**                                                                                                      |
|----------------------------|---------------------|-------------------|--------------------------------------------------------------------------|-----------------|----------|----------------------------------------------------------------------------------------------------------------------|
| Player                     |                     | Both              | PlayerNameOrID, Report                                                   | User            | No       | Displays information about the given player. Gives a verbose response if the component parameter is omitted.         |
| Currency                   |                     | Both              | CurrencyNameOrID, TopHoldersCount*, useTradeCount*, useBackingInfo*      | User            | No       | Displays information about the given currency.                                                                       |
| Currencies                 |                     | Both              | CurrencyType, MaxCurrenciesPerType*, HoldersPerCurrency*                 | User            | No       | Displays information about the top used currencies.                                                                  |
| Election                   |                     | Both              | ElectionNameOrID                                                         | User            | No       | Displays information about the given election.                                                                       |
| Elections                  |                     | Both              |                                                                          | User            | No       | Displays information about the currently active elections.                                                           |
| WorkParty                  |                     | Both              | WorkPartyNameOrID                                                        | User            | No       | Displays information about the given work party.                                                                     |
| WorkParties                |                     | Both              |                                                                          | User            | No       | Displays information about the currently active work parties.                                                        |
| Skills                     |                     | Discord / Moose   | IncludeInactive*, IncludeScrollNoStar*, SettlementFilter*                | User            | No       | Displays information about skill distribution for all players or a specific settlement.                              |
| Bounties                   |                     | Discord / Moose   | IncludeInactive*, SettlementFilter*, PlayerFilter*                       | User            | No       | Displays information about available repair bounties.                                                                |
