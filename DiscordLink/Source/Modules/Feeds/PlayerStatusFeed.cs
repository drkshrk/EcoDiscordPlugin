...
namespace Eco.Plugins.DiscordLink.Modules
{
    class PlayerStatusFeed : FeedModule
    {
        ...
        {
            foreach (ChannelLink link in ServerConfig.Data.PlayerStatusFeedChannels)
            {
                if (link.IsValid())
                    return true;
            }
        ...
        protected override async Task UpdateInternal(DiscordLink plugin, DlEventType trigger, params object[] data)
        {
            ...
            foreach (ChannelLink playerStatusLink in ServerConfig.Data.PlayerStatusFeedChannels)
            {
