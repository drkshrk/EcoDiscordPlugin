...
namespace Eco.Plugins.DiscordLink.Modules
{
    class ServerLogFeed : FeedModule
    {
        ...
        {
            foreach (ChannelLink link in DiscordLinkConfig.ServerLogFeedChannels)
            {
                if (link.IsValid())
                    return true;
            }
        ...
        protected override async Task UpdateInternal(DiscordLink plugin, DlEventType trigger, params object[] data)
        {
            ...
            foreach (ServerLogFeedChannelLink serverFeedLink in DiscordLinkConfig.ServerLogFeedChannels)
            {
